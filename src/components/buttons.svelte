...
<button bind:this={buttonCreateBars} class="btn btn-primary" on:click={createCertainAmountOfBars} style="background: {$colors}; border-color: {$colors};">Create bars</button>
